...
export const  getAsyncMovieKeywordsWithMovieId = createAsyncThunk("Movies/getAsyncMovieKeywordsWithMovieId" , async(movieId ,{rejectWithValue}) => {    
    try {
        const movieKeywords = await axios.get(`https://data-imdb1.p.rapidapi.com/movie/id/${movieId}/keywords/`,{
            headers : {
